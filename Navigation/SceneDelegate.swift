...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        feedViewController.view.backgroundColor = .systemGray2
        ...
        let postImage = UIImage(systemName: "folder")
        postViewController.tabBarItem = UITabBarItem(title: "Выбранный Пост", image: postImage, tag: 2)
        ...
        tabBarController.viewControllers = [feedNavigationController, profileViewController, postViewController]
